...
data_path = ['/exports/chss/eddie/ppls/groups/lel_hcrc_cstr_students/s2226669_Wenjing_Shi/selfversion/PyTorch/SpeechSynthesis/FastPitch/filelists/ljs_audio_pitch_prom_text_val.txt']
...
log_file = open("incorrect_label_val.txt", "a")
